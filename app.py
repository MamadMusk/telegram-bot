...
def start_broadcast(chat_id):
    ...
    # ذخیره message_id برای پردازش بعدی
        ...
        if request.headers.get('content-type') == 'application/json':
            ...
            if update.callback_query:
                ...
                # ===== تنظیمات =====
                    ...
                    bot.user_data = getattr(bot, 'user_data', {})
                    bot.user_data[chat_id] = {'step': 'set_quota', 'message_id': msg.message_id}
                    return 'OK', 200
                    ...
                    bot.user_data = getattr(bot, 'user_data', {})
                    bot.user_data[chat_id] = {'step': 'set_size', 'message_id': msg.message_id}
                    return 'OK', 200
            ...
            # ===== پردازش پیام =====
                ...
                if step_data.get('step') == 'add_admin':
                    try:
                ...
                elif step_data.get('step') == 'add_force_channel':
                    channel = text.strip()
                ...
                elif step_data.get('step') == 'set_quota':
                    try:
                ...
                elif step_data.get('step') == 'set_size':
                    try:
                        value = int(text.strip())
                ...
                elif step_data.get('step') == 'broadcast':
