...
def get_admin_keyboard(lang: str = "fa"):
    """
    کیبورد مدیریت با ترتیب:
    ردیف 1: مدیریت کاربران | گزارش | آمار
    ردیف 2: قفل اسپانسر | ارسال همگانی
    ردیف 3: تنظیمات
    """
    ...
    if lang == "en":
        ...
        btn_report = KeyboardButton("📋 Report")
    ...
    # ردیف ۱: سه دکمه
    keyboard.add(btn_users, btn_report, btn_stats)
