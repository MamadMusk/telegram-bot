...
• viewer - فقط مشاهده""",
    ...
    "admin_remove_prompt": "👤 روی دکمه‌ی حذف ادمین مورد نظر کلیک کنید:",
...
# ===================================================
# 🔐 دکمه‌های شیشه‌ای (Inline Keyboard) برای مدیریت
# ===================================================
